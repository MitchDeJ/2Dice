            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-2 text-center">
                        <a href="{{url('expand')}}" class="text-dark">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td>Wood</td>
                            <td>{{number_format($company->wood)}} / {{number_format($limit)}}</td>
                            <td>
                                {!! Form::open(['route' => ['company.deposit'], 'method' => 'post', 'class' => 'form-inline']) !!}
                                <input type="number" class="form-control" placeholder="Amount" id="offer"
                                       name="amount">
                                {!! Form::hidden("item", 0) !!}
                                <button type="submit" class="btn btn-default">Deposit</button>
                        ...
                        <tr>
                            <td>Stone</td>
                            <td>{{number_format($company->stone)}} / {{number_format($limit)}}</td>
                            <td>
                                {!! Form::open(['route' => ['company.deposit'], 'method' => 'post', 'class' => 'form-inline']) !!}
                                <input type="number" class="form-control" placeholder="Amount" id="offer"
                                       name="amount">
                        ...
                        <tr>
                            <td>Oil</td>
                            <td>{{number_format($company->oil)}} / {{number_format($limit)}}</td>
                            <td>
                                {!! Form::open(['route' => ['company.deposit'], 'method' => 'post', 'class' => 'form-inline']) !!}
                                <input type="number" class="form-control" placeholder="Amount" id="offer"
                                       name="amount">
                        ...
                        <tr>
                            <td>Planks</td>
                            <td>{{number_format($company->planks)}} / {{number_format($limit)}}</td>
                            <td>
                                {!! Form::open(['route' => ['company.deposit'], 'method' => 'post', 'class' => 'form-inline']) !!}
                                <input type="number" class="form-control" placeholder="Amount" id="offer"
                                       name="amount">
                        ...
                        <tr>
                            <td>Bricks</td>
                            <td>{{number_format($company->bricks)}} / {{number_format($limit)}}</td>
                            <td>
                                {!! Form::open(['route' => ['company.deposit'], 'method' => 'post', 'class' => 'form-inline']) !!}
                                <input type="number" class="form-control" placeholder="Amount" id="offer"
                                       name="amount">
                        ...
                        <tr>
                            <td>Gasoline</td>
                            <td>{{number_format($company->gasoline)}} / {{number_format($limit)}}</td>
                            <td>
                                {!! Form::open(['route' => ['company.deposit'], 'method' => 'post', 'class' => 'form-inline']) !!}
                                <input type="number" class="form-control" placeholder="Amount" id="offer"
                                       name="amount">
                    ...
                    <b>Quick-sell</b>
                    <br>
                    <p>For current quick-sell prices, check out the <a class="text-dark"
                                                                       href="{{url('/marketprices')}}">Market prices
                            page.</a></p>
