                ...
                <div class="col-md-6"> <br>
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td><i class="fa fa-star i_button_background"></i> Rank: {{$user->rank}} (Prestige 0)</td>
                            </tr>
                            <tr>
                                <td><i class="fa fa-rocket i_button_background"></i> Power: {{number_format($user->power)}}</td>
                            </tr>
                            <tr>
                ...
                <div class="col-md-6"> <br>
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <tr>
                                <td><i class="fa fa-area-chart i_button_background"></i> Stone: {{number_format($user->stone)}}</td>
                            </tr>
                            <tr>
                                <td><i class="fa fa-area-chart i_button_background"></i> Wood: {{number_format($user->wood)}}</td>
                            </tr>
                            <tr>
                                <td><i class="fa fa-area-chart i_button_background"></i> Wheat: {{number_format($user->wheat)}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td><i style="color: #f39c12;" class="fa fa-cube i_button_background"></i> Prestige points: {{number_format($user->prestigepoints)}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
